...
## [Coursera / Specialization](#list)

(Bgn.: Beginner / Itm.: Intermediate / Adv.: Advanced)

| Title | Language | Level | Hours | Plus | Korean | Partner |
|:--|:-:|:-:|--:|:-:|:-:|:-:|
| [**Applied Data Science**](https://www.coursera.org/specializations/applied-data-science) | Python | Bgn. | 69 | × | ○ | IBM |
...
| [**Blockchain**](https://www.coursera.org/specializations/blockchain) | Solidity | Itm. | 67 | ○ | ○ | University at Buffalo +1 |
...
| [**Data Science Foundations: Data Structures and Algorithms**](https://www.coursera.org/specializations/boulder-data-structures-algorithms) | Python | Adv. | 106 | ○ | × | University of Colorado Boulder |
...
| [**Data Science: Foundations using R**](https://www.coursera.org/specializations/data-science-foundations-r) | R | Bgn. | 158 | ○ | ○ | Johns Hopkins University |
...
| [**FPGA Design for Embedded Systems**](https://www.coursera.org/specializations/fpga-design) | VHDL Verilog | Itm. | 93 | ○ | × | University of Colorado Boulder |
...
| [**Excel/VBA for Creative Problem Solving**](https://www.coursera.org/specializations/excel-vba-creative-problem-solving) | VBA | Bgn. | 54 | ○ | × | University of Colorado Boulder |
...
| [**Java as a Second Language**](https://www.coursera.org/specializations/java-programming-language) | Java | Itm. | | ○ | × | LearnQuest |
...
| [**Mathematics for Engineers**](https://www.coursera.org/specializations/mathematics-engineers) | MATLAB | Bgn. | 127 | ○ | × | The Hong Kong University of Science and Technology |
...
| [**Mathematics for Machine Learning**](https://www.coursera.org/specializations/mathematics-machine-learning) | Python | Bgn. | 55 | ○ | × | Imperial College London |
...
| [**Practical Data Science with MATLAB**](https://www.coursera.org/specializations/practical-data-science-matlab) | MATLAB | Bgn. | 72 | ○ | × | MathWorks |
...
| [**Programming with Google Go**](https://www.coursera.org/specializations/google-golang) | Golang | Itm. | 28 | ○ | × | University of California, Irvine |
...
| [The Unix Workbench](https://www.coursera.org/learn/unix) | Bash | Bgn. | 19 | ○ | × | Johns Hopkins University |